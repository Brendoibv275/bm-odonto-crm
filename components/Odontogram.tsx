...
const Odontogram: React.FC<OdontogramProps> = ({ teeth, selectedTooth, onSelectTooth }) => {
  ...
  // Patient's view for display (common dental chart orientation)
  // Upper: Patient's Left Side (Q2) | Patient's Right Side (Q1)
  // Lower: Patient's Left Side (Q3) | Patient's Right Side (Q4)
